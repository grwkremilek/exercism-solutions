...
class BowlingTest(unittest.TestCase):
    ...
    def test_should_be_able_to_score_a_game_with_all_zeros(self):                   #1
    ...
    def test_should_be_able_to_score_a_game_with_no_strikes_or_spares(self):        #2
    ...
    def test_a_spare_follow_by_zeros_is_worth_ten_points(self):                     #3
    ...
    def test_points_scored_in_the_roll_after_a_spare_are_counted_twice(self):       #4
    ...
    def test_consecutive_spares_each_get_a_one_roll_bonus(self):                    #5
    ...
    def test_last_frame_spare_gets_bonus_roll_that_is_counted_twice(self):          #6
    ...
    def test_a_strike_earns_ten_points_in_a_frame_with_a_single_roll(self):         #7
    ...
    def test_two_rolls_points_after_strike_are_counted_twice(self):                 #8
    ...
    def test_consecutive_stikes_each_get_the_two_roll_bonus(self):                  #9
    ...
    def test_strike_in_last_frame_gets_two_roll_bonus_counted_once(self):           #10
    ...
    def test_rolling_spare_with_bonus_roll_does_not_get_bonus(self):                #11
    ...
    def test_strikes_with_the_two_bonus_rolls_do_not_get_bonus_rolls(self):         #12
    ...
    def test_strike_with_bonus_after_spare_in_last_frame_gets_no_bonus(self):       #13
    ...
    def test_all_strikes_is_a_perfect_game(self):                                   #14
